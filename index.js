...
function fun(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            document.getElementById('save').onclick = function () {
                ...
                if (/^[\d\.]+$/.test(text) && parseFloat(text) > 36.0 && parseFloat(text) < 37.2) {
                    ...
                    fetch("./php/set_new_temp.php/?id=" + id + "&temp=" + text)
                        .then(function () {
                        document.getElementById('chart').src = "./php/draw_image.php/?zz=" + Date.now();
                        modal.classList.remove('active');
                    });
                }
            };
            document.getElementById('sick').onclick = function () {
            ...
            document.getElementById('no-data').onclick = function () {
